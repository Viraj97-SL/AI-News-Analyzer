...
class NewsArticleModel(Base):
    ...
    story_cluster_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
...
class SummaryModel(Base):
    ...
    credibility_score: Mapped[float] = mapped_column(Float, default=0.0)
    source_urls: Mapped[str | None] = mapped_column(Text, nullable=True)   # JSON array of URLs
    outlet_names: Mapped[str | None] = mapped_column(Text, nullable=True)  # JSON array e.g. ["NYT","Bloomberg"]
    bias_notes: Mapped[str | None] = mapped_column(Text, nullable=True)    # cross-outlet angle differences
    story_cluster_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
